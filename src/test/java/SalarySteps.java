...
import org.uk.base.Employee;
import org.uk.base.SalaryManager;
...
public class SalarySteps {
    ...
    @When("^the boss request the total of the salaries$")
    public void the_boss_request_the_total_of_the_salaries() throws Throwable {
        manager.sumTotal();
    ...
    public void the_total_should_be(int arg1) throws Throwable {
        ...
        assertThat(manager.getTotal() , equalTo(485250.0f));
    }
}
